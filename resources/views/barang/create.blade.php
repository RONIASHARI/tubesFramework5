        ...
        <form action="{{ route('barangg.store') }}" method="POST">
            ...
            <div class="row justify-content-center">
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <hr>
                    <form action="/barangg" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                    ...
                    @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('DeskripsiProduk') is-invalid @enderror" type="text"
                                name="deskripsiproduk" id="DeskripsiProduk" value="{{ old('DeskripsiProduk') }}"
